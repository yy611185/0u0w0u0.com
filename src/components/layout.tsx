    ...
    <nav class="nav" id="site-nav" aria-label="主导航">
      <div class="nav-inner">
        ...
        <div class="nav-links" id="nav-links">
          {NAV_LINKS.map((l) => (
            <a href={l.href} aria-current={isCurrent(path, l.href) ? 'page' : undefined}>
              {l.label}
            </a>
          ))}
        </div>
  ...
  <footer class="footer" id="contact" aria-labelledby="footer-brand">
    <div class="container footer-inner">
      <div class="footer-grid">
        <div>
          <p class="footer-brand" id="footer-brand">
            {SITE.name}
          </p>
...
export const Lightbox: FC = () => (
  ...
  >
    ...
    <button type="button" class="lb-close" data-lightbox-close aria-label="关闭查看器 (Esc)">
      <CloseIcon />
    </button>
    ...
    <figure class="lightbox-figure">
      <img
        id="lightbox-img"
        alt=""
        width={IMAGES.heroScene.w}
        height={IMAGES.heroScene.h}
        decoding="async"
      />
      <figcaption>
